...
{
    public class ModularSingleActionRevolver : SingleActionRevolver , IModularWeapon
    {
        ...
        {
            SingleActionRevolver[] singleActionRevolvers = GetComponents<SingleActionRevolver>();
            SingleActionRevolver toCopy = singleActionRevolvers.Single(c => c != this);
            ...
            SingleActionEjectorRod ejector = toCopy.GetComponentInChildren<SingleActionEjectorRod>();
            if (ejector != null) ejector.Revolver = this;
            ...
            CopySingleActionRevolver(toCopy);
        }

        public void CopySingleActionRevolver(SingleActionRevolver reference)
        {
            Type type = typeof(SingleActionRevolver);
